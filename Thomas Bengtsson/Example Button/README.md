This example lets you create a clickable button. It starts of with 1000 possible clicks and for each time the button is clicked, the counter will be reduced by one. 
